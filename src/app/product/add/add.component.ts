...
export class AddComponent implements OnInit {
  ...
  units:Observable<Lookup[]> = null;
  categories:Observable<Lookup[]> = null;

  formSubmitted = false;

  constructor(private fb:FormBuilder, private lookupService:LookupService,private productService:ProductService,private router: Router, private route: ActivatedRoute) { }
